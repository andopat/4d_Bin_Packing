...
class KFACOptimizer(optim.Optimizer):
    ...
    def _prepare_model(self):
        # print(self.model)
        # print("len", len(self.known_modules), "===\n", self.known_modules, "***\n")
    ...
    def step(self):
        ...
        for i, m in enumerate(self.modules):
            ...
            if self.steps % self.Tf == 0:
                # My asynchronous implementation exists, I will add it later. Experimenting with different ways to this in PyTorch.
                ...
                # print("\tklk", klk, i, classname, len(self.modules))
                # klk += 1
